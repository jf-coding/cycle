...
/**
 * The bgei instruction class.
 */
public class bgei extends Instruction
{
 ...
 /**
  * Instantiates a new bgei instruction.
  *
  ...
  */
 public bgei(fw_3sp cpu,int address,int rA,int imm,int latency,int cond_latency)
 {
  this.cpu = cpu;
  pc = address;
  this.rA = rA;
