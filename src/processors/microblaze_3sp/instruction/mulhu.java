...
/**
 * The mulhu instruction class.
 */
public class mulhu extends Instruction
{
 ...
 /**
  * Instantiates a new mulhu instruction.
  *
  ...
  */
 public mulhu(fw_3sp cpu,int address,int rD,int rA,int rB,int latency)
 {
  this.cpu = cpu;
  pc = address; 
  this.rD = rD;
