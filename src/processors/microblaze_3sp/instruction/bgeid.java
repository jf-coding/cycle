...
/**
 * The bgeid instruction class.
 */
public class bgeid extends Instruction
{ 
 ...
 /**
  * Instantiates a new bgeid instruction.
  *
  ...
  */
 public bgeid(fw_3sp cpu,int address,int rA,int imm,int latency,int cond_latency)
 {
  this.cpu = cpu;
  pc = address;
  this.rA = rA;
