...
/**
 * The beqid instruction class.
 */
public class beqid extends Instruction
{
 ...
 /**
  * Instantiates a new beqid instruction.
  *
  ...
  */
 public beqid(fw_3sp cpu,int address,int rA,int imm,int latency,int cond_latency)
 {
  this.cpu = cpu;
  pc = address;
  this.rA = rA;
