...
/**
 * The sbi instruction class.
 */
public class sbi extends Instruction
{
 ...
 /**
  * Instantiates a new sbi instruction.
  *
  ...
  */
 public sbi(Memory memory,fw_3sp cpu,int address,int rD,int rA,int imm,int latency)
 {
  this.cpu = cpu;
  this.memory = memory;
  pc = address;
 ...
 public final int Stage(int stage)
 {
  ...
  status = memory.putByte(address,aux_d);
  switch(status)
  {
