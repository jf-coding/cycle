...
/**
 * The rtbd instruction class.
 */
public class rtbd extends Instruction
{
 ...
 /**
  * Instantiates a new rtbd instruction.
  *
  ...
  */
 public rtbd(fw_3sp cpu,int address,int rA,int imm,int latency)
 {
  this.cpu = cpu;
  pc = address;
  this.rA = rA;
