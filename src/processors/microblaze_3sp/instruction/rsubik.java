...
/**
 * The rsubik instruction class.
 */
public class rsubik extends Instruction
{
 ...
 /**
  * Instantiates a new rsubik instruction.
  *
  ...
  */
 public rsubik(fw_3sp cpu,int address,int rD,int rA,int imm,int latency)
 {
  this.cpu = cpu;
  pc = address;
  this.rD = rD;
