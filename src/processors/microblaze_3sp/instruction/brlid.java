...
/**
 * The brlid instruction class.
 */
public class brlid extends Instruction
{
 ...
 /**
  * Instantiates a new brlid instruction.
  *
  ...
  */
 public brlid(fw_3sp cpu,int address,int rD,int imm,int latency)
 {
  this.cpu = cpu;
  pc = address;
  this.rD = rD;
