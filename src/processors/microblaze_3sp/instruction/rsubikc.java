...
/**
 * The rsubikc instruction class.
 */
public class rsubikc extends Instruction
{
 ...
 /**
  * Instantiates a new rsubikc instruction.
  *
  ...
  */
 public rsubikc(fw_3sp cpu,int address,int rD,int rA,int imm,int latency)
 {
  this.cpu = cpu;
  pc = address;
  this.rD = rD;
