...
/**
 * The bgtid instruction class.
 */
public class bgtid extends Instruction
{
 ...
 /**
  * Instantiates a new bgtid instruction.
  *
  ...
  */
 public bgtid(fw_3sp cpu,int address,int rA,int imm,int latency,int cond_latency)
 {
  this.cpu = cpu;
  pc = address;
  this.rA = rA;
