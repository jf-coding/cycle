...
/**
 * The msrset instruction class.
 */
public class msrset extends Instruction
{
 ...
 /**
  * Instantiates a new msrset instruction.
  *
  ...
  */
 public msrset(fw_3sp cpu,int address,int rD,int imm_14,int latency)
 {
  this.cpu = cpu;
  pc = address; 
  this.rD = rD;
