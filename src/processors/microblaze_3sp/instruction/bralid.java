...
/**
 * The bralid instruction class.
 */
public class bralid extends Instruction
{
 ...
 /**
  * Instantiates a new bralid instruction.
  *
  ...
  */
 public bralid(fw_3sp cpu,int address,int rD,int imm,int latency)
 {
  this.cpu = cpu;
  pc = address;
  this.rD = rD;
