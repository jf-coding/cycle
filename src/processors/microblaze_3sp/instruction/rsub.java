...
public class rsub extends Instruction
{
 ...
 /**
  * Instantiates a new rsub instruction.
  *
  ...
  */
 public rsub(fw_3sp cpu,int address,int rD,int rA,int rB,int latency)
 {
  this.cpu = cpu;
  pc = address;
  this.rD = rD;
