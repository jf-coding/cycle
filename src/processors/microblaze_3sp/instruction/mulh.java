...
/**
 * The mulh instruction class.
 */
public class mulh extends Instruction
{
 ...
 /**
  * Instantiates a new mulh instruction.
  *
  ...
  */
 public mulh(fw_3sp cpu,int address,int rD,int rA,int rB,int latency)
 {
  this.cpu = cpu;
  pc = address; 
  this.rD = rD;
