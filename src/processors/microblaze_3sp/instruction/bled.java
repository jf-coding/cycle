...
/**
 * The bled instruction class.
 */
public class bled extends Instruction
{
 ...
 /**
  * Instantiates a new bled instruction.
  *
  ...
  */
 public bled(fw_3sp cpu,int address,int rA,int rB,int latency,int cond_latency)
 {
  this.cpu = cpu;
  pc = address;
  this.rA = rA;
