...
/**
 * The pcmpne instruction class.
 */
public class pcmpne extends Instruction
{
 ...
 /**
  * Instantiates a new pcmpne instruction.
  *
  ...
  */
 public pcmpne(fw_3sp cpu,int address,int rD,int rA,int rB,int latency)
 {
  this.cpu = cpu;
  pc = address;
  this.rD = rD;
