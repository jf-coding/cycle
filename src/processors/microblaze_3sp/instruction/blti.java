...
/**
 * The blti instruction class.
 */
public class blti extends Instruction
{
 ...
 /**
  * Instantiates a new blti instruction.
  *
  ...
  */
 public blti(fw_3sp cpu,int address,int rA,int imm,int latency,int cond_latency)
 {
  this.cpu = cpu;
  pc = address;
  this.rA = rA;
