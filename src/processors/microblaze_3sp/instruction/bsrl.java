...
/**
 * The bsrl instruction class.
 */
public class bsrl extends Instruction
{
 ...
 /**
  * Instantiates a new bsrl instruction.
  *
  ...
  */
 public bsrl(fw_3sp cpu,int address,int rD,int rA,int rB,int latency)
 {
  this.cpu = cpu;
  pc = address;
  this.rD = rD;
