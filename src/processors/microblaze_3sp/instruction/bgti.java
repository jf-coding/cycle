...
/**
 * The bgti instruction class.
 */
public class bgti extends Instruction
{
 ...
 /**
  * Instantiates a new bgti instruction.
  *
  ...
  */
 public bgti(fw_3sp cpu,int address,int rA,int imm,int latency,int cond_latency)
 {
  this.cpu = cpu;
  pc = address;
  this.rA = rA;
