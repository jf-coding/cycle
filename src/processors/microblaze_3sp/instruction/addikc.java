...
/**
 * The addikc instruction class.
 */
public class addikc extends Instruction
{
 ...
 /**
  * Instantiates a new addikc instruction.
  *
  ...
  */
 public addikc(fw_3sp cpu,int address,int rD,int rA,int imm,int latency)
 {
  this.cpu = cpu;
  pc = address;
  this.rD = rD;
