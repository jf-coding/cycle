...
/**
 * The addk instruction class.
 */
public class addk extends Instruction
{
 ...
 /**
  * Instantiates a new addk instruction.
  *
  ...
  */
 public addk(fw_3sp cpu,int address,int rD,int rA,int rB,int latency)
 {
  this.cpu = cpu;
  pc = address;
  this.rD = rD;
