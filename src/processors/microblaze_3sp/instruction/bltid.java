...
/**
 * The bltid instruction class.
 */
public class bltid extends Instruction
{
 ...
 /**
  * Instantiates a new bltid instruction.
  *
  ...
  */
 public bltid(fw_3sp cpu,int address,int rA,int imm,int latency,int cond_latency)
 {
  this.cpu = cpu;
  pc = address;
  this.rA = rA;
