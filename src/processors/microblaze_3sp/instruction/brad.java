...
/**
 * The brad instruction class.
 */
public class brad extends Instruction
{
 ...
 /**
  * Instantiates a new brad instruction.
  *
  ...
  */
 public brad(fw_3sp cpu,int address,int rB,int latency)
 {
  this.cpu = cpu;
  pc = address;
  this.rB = rB;
