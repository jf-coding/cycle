...
/**
 * The blei instruction class.
 */
public class blei extends Instruction
{
 ...
 /**
  * Instantiates a new blei instruction.
  *
  ...
  */
 public blei(fw_3sp cpu,int address,int rA,int imm,int latency,int cond_latency)
 {
  this.cpu = cpu;
  pc = address;
  this.rA = rA;
