...
/**
 * The bsrli instruction class.
 */
public class bsrli extends Instruction
{
 ...
 /**
  * Instantiates a new bsrli instruction.
  *
  ...
  */
 public bsrli(fw_3sp cpu,int address,int rD,int rA,int imm_5,int latency)
 {
  this.cpu = cpu;
  pc = address;
  this.rD = rD;
