...
/**
 * The bneid instruction class.
 */
public class bneid extends Instruction
{
 ...
 /**
  * Instantiates a new bneid instruction.
  *
  ...
  */
 public bneid(fw_3sp cpu,int address,int rA,int imm,int latency,int cond_latency)
 {
  this.cpu = cpu;
  pc = address;
  this.rA = rA;
