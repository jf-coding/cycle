...
/**
 * The bsra instruction class.
 */
public class bsra extends Instruction
{
 ...
 /**
  * Instantiates a new bsra instruction.
  *
  ...
  */
 public bsra(fw_3sp cpu,int address,int rD,int rA,int rB,int latency)
 {
  this.cpu = cpu;
  pc = address;
  this.rD = rD;
