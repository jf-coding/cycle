...
/**
 * The rsubkc instruction class.
 */
public class rsubkc extends Instruction
{
 ...
 /**
  * Instantiates a new rsubkc instruction.
  *
  ...
  */
 public rsubkc(fw_3sp cpu,int address,int rD,int rA,int rB,int latency)
 {
  this.cpu = cpu;
  pc = address;
  this.rD = rD;
