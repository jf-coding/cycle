...
/**
 * The braid instruction class.
 */
public class braid extends Instruction
{
 ...
 /**
  * Instantiates a new braid instruction.
  *
  ...
  */
 public braid(fw_3sp cpu,int address,int imm,int latency)
 {
  this.cpu = cpu;
  pc = address;
  this.imm = imm;
