...
/**
 * The bsrai instruction class.
 */
public class bsrai extends Instruction
{
 ...
 /**
  * Instantiates a new bsrai instruction.
  *
  ...
  * @param imm_5 the 5 bit immediate value.
  * @param latency the instruction's latency in the execute stage.
  */
 public bsrai(fw_3sp cpu,int address,int rD,int rA,int imm_5,int latency)
 {
  this.cpu = cpu;
  pc = address;
  this.rD = rD;
