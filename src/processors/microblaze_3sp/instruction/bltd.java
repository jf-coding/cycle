...
/**
 * The bltd instruction class.
 */
public class bltd extends Instruction
{
 ...
 /**
  * Instantiates a new bltd instruction.
  *
  ...
  */
 public bltd(fw_3sp cpu,int address,int rA,int rB,int latency,int cond_latency)
 {
  this.cpu = cpu;
  pc = address;
  this.rA = rA;
