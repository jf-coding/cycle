...
/**
 * The bnei instruction class.
 */
public class bnei extends Instruction
{
 ...
 /**
  * Instantiates a new bnei instruction.
  *
  ...
  */
 public bnei(fw_3sp cpu,int address,int rA,int imm,int latency,int cond_latency)
 {
  this.cpu = cpu;
  pc = address;
  this.rA = rA;
