...
/**
 * The lbui instruction class.
 */
public class lbui extends Instruction
{
 ...
 /**
  * Instantiates a new lbui instruction.
  *
  ...
  */
 public lbui(Memory memory,fw_3sp cpu,int address,int rD,int rA,int imm,int latency)
 {
  this.cpu = cpu;
  this.memory = memory;
  pc = address;
