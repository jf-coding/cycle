...
/**
 * The bleid instruction class.
 */
public class bleid extends Instruction
{
 ...
 /**
  * Instantiates a new bleid instruction.
  *
  ...
  */
 public bleid(fw_3sp cpu,int address,int rA,int imm,int latency,int cond_latency)
 {
  this.cpu = cpu;
  pc = address;
  this.rA = rA;
