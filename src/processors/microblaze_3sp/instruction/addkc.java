...
/**
 * The addkc instruction class.
 */
public class addkc extends Instruction
{
 ...
 /**
  * Instantiates a new addkc instruction.
  *
  ...
  * @param rB the source register B.S
  * @param latency the instruction's latency in the execute stage.
  */
 public addkc(fw_3sp cpu,int address,int rD,int rA,int rB,int latency)
 {
  this.cpu = cpu;
  pc = address;
  this.rD = rD;
