...
/**
 * The lhui instruction class.
 */
public class lhui extends Instruction
{
 ...
 /**
  * Instantiates a new lhui instruction.
  *
  ...
  */
 public lhui(Memory memory,fw_3sp cpu,int address,int rD,int rA,int imm,int latency)
 {
  this.cpu = cpu;
  this.memory = memory;
  pc = address;
