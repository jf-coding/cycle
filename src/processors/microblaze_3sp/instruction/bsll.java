...
/**
 * The bsll instruction class.
 */
public class bsll extends Instruction
{
 ...
 /**
  * Instantiates a new bsll instruction.
  *
  ...
  */
 public bsll(fw_3sp cpu,int address,int rD,int rA,int rB,int latency)
 {
  this.cpu = cpu;
  pc = address;
  this.rD = rD;
