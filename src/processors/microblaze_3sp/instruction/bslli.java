...
/**
 * The bslli instruction class.
 */
public class bslli extends Instruction
{
 ...
 /**
  * Instantiates a new bslli instruction.
  *
  ...
  */
 public bslli(fw_3sp cpu,int address,int rD,int rA,int imm_5,int latency)
 {
  this.cpu = cpu;
  pc = address;
  this.rD = rD;
