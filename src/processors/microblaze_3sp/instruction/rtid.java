...
/**
 * The rtid instruction class.
 */
public class rtid extends Instruction
{
 ...
 /**
  * Instantiates a new rtid instruction.
  *
  ...
  */
 public rtid(fw_3sp cpu,int address,int rA,int imm,int latency)
 {
  this.cpu = cpu;
  pc = address;  
  this.rA = rA;
