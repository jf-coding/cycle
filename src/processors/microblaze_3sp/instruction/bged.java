...
/**
 * The bged instruction class.
 */
public class bged extends Instruction
{
 ...
 /**
  * Instantiates a new bged instruction.
  *
  ...
  */
 public bged(fw_3sp cpu,int address,int rA,int rB,int latency,int cond_latency)
 {
  this.cpu = cpu;
  pc = address;
  this.rA = rA;
