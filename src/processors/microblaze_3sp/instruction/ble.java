...
/**
 * The ble instruction class.
 */
public class ble extends Instruction
{
 ...
 /**
  * Instantiates a new ble instruction.
  *
  ...
  */
 public ble(fw_3sp cpu,int address,int rA,int rB,int latency,int cond_latency)
 {
  this.cpu = cpu;
  pc = address;
  this.rA = rA;
