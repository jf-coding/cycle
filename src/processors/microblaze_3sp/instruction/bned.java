...
/**
 * The bned instruction class.
 */
public class bned extends Instruction
{
 ...
 /**
  * Instantiates a new bned instruction.
  *
  ...
  */
 public bned(fw_3sp cpu,int address,int rA,int rB,int latency,int cond_latency)
 {
  this.cpu = cpu;
  pc = address;
  this.rA = rA;
