...
/**
 * The rsubk instruction class.
 */
public class rsubk extends Instruction
{
 ...
 /**
  * Instantiates a new rsubk instruction.
  *
  ...
  */
 public rsubk(fw_3sp cpu,int address,int rD,int rA,int rB,int latency)
 {
  this.cpu = cpu;
  pc = address;
  this.rD = rD;
