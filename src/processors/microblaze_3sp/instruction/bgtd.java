...
/**
 * The bgtd instruction class.
 */
public class bgtd extends Instruction
{
 ...
 /**
  * Instantiates a new bgtd instruction.
  *
  ...
  */
 public bgtd(fw_3sp cpu,int address,int rA,int rB,int latency,int cond_latency)
 {
  this.cpu = cpu;
  pc = address;
  this.rA = rA;
