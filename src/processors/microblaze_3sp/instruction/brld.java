...
/**
 * The brld instruction class.
 */
public class brld extends Instruction
{
 ...
 /**
  * Instantiates a new brld instruction.
  *
  ...
  */
 public brld(fw_3sp cpu,int address,int rD,int rB,int latency)
 {
  this.cpu = cpu;
  pc = address;
  this.rD = rD;
