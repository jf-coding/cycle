...
/**
 * The rted instruction class.
 */
public class rted extends Instruction
{
 ...
 /**
  * Instantiates a new rted instruction.
  *
  ...
  */
 public rted(fw_3sp cpu,int address,int rA,int imm,int latency)
 {
  this.cpu = cpu;
  pc = address;
  this.rA = rA;
