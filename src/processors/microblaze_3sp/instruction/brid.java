...
/**
 * The brid instruction class.
 */
public class brid extends Instruction
{
 ...
 /**
  * Instantiates a new brid instruction.
  *
  ...
  */
 public brid(fw_3sp cpu,int address,int imm,int latency)
 {
  this.cpu = cpu;
  pc = address;
  this.imm = imm;
