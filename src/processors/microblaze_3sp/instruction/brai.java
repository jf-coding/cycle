...
/**
 * The brai instruction class.
 */
public class brai extends Instruction
{
 ...
 /**
  * Instantiates a new brai instruction.
  *
  ...
  */
 public brai(fw_3sp cpu,int address,int imm,int latency)
 {
  this.cpu = cpu;
  pc = address;
  this.imm = imm;
