...
/**
 * The beqd instruction class.
 */
public class beqd extends Instruction
{
 ...
 /**
  * Instantiates a new beqd instruction.
  *
  ...
  */
 public beqd(fw_3sp cpu,int address,int rA,int rB,int latency,int cond_latency)
 {
  this.cpu = cpu;
  pc = address;
  this.rA = rA;
