...
/**
 * The andni instruction class.
 */
public class andni extends Instruction
{
 ...
 /**
  * Instantiates a new andni instruction.
  *
  ...
  */
 public andni(fw_3sp cpu,int address,int rD,int rA,int imm,int latency)
 {
  this.cpu = cpu;
  pc = address;
  this.rD = rD;
